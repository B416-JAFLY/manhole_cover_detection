...
# 示例用法
img_folder = '../../images_dataset_yolo/images'  # 图片文件夹路径
lbl_folder = '../../images_dataset_yolo/labels'  # 标签文件夹路径

train_img_folder = '../../images_dataset_yolo/images/train'  # 训练集图片文件夹路径
val_img_folder = '../../images_dataset_yolo/images/val'  # 验证集图片文件夹路径
train_lbl_folder = '../../images_dataset_yolo/labels/train'  # 训练集标签文件夹路径
val_lbl_folder = '../../images_dataset_yolo/labels/val'  # 验证集标签文件夹路径
